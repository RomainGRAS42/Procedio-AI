...
Deno.serve(async (req) => {
  ...
  try {
    const { question, file_id, userName } = await req.json();
        ...
        messages: [
          {
            ...
            2. Si la réponse n'est pas dans le contexte, dis poliment que tu ne sais pas et que l'utilisateur devrait consulter un manager.
