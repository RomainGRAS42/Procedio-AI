              ...
              {searchResults.length > 0 ? searchResults.map(res => (
                ...
                >
                   <div className="flex justify-between items-start mb-4">
                     <div className="w-12 h-12 bg-rose-50 text-rose-500 rounded-xl flex items-center justify-center text-xl group-hover:bg-rose-500 group-hover:text-white transition-all shadow-sm shrink-0">
                   ...
                   <div className="flex-1 w-full">
                     <span className="font-bold text-slate-800 block truncate text-xs mb-4 group-hover:text-indigo-600 transition-colors uppercase tracking-tight">{res.title}</span>
                   </div>

                   <div className="w-full border-t border-slate-50 pt-3 flex items-center justify-between mt-auto">
                     <div className="flex items-center gap-1.5 text-[9px] font-bold text-slate-300">
                       <i className="fa-solid fa-eye text-[8px]"></i> {res.views || 0}
                     </div>
                     <i className="fa-solid fa-arrow-right text-[10px] text-slate-200 group-hover:text-indigo-400 group-hover:translate-x-1 transition-all"></i>
                   </div>
                   {/* Squircle corner decor */}
                   <div className="absolute -bottom-6 -right-6 w-16 h-16 bg-rose-500/5 rounded-full blur-2xl group-hover:bg-rose-500/10 transition-colors"></div>
                </div>
              )) : (
