...
const TeamPodium: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-[2.5rem] px-8 pt-8 pb-16 border border-slate-100 shadow-sm flex flex-col gap-6 animate-fade-in relative min-h-[350px] shrink-0 z-30 mb-8">
