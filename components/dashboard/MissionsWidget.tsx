...
const MissionsWidget: React.FC<MissionsWidgetProps> = ({
  ...
  if (isTeamView) {
    return (
      <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm flex flex-col relative h-[calc(100%-1rem)] max-h-full">
        ...
        <div className="space-y-2 flex-1 pr-1 overflow-y-auto custom-scrollbar">
          {loading ? (
