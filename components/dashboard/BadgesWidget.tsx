...
const BadgesWidget: React.FC<BadgesWidgetProps> = ({
  ...
  else if (totalSuggestions < 1) { nextObjective = { title: "Proposez 1 amélioration", subtitle: "Trophée Innovateur", description: "Participez à l'évolution de la base de connaissances en proposant votre première amélioration.", current: totalSuggestions, target: 1, unit: "Amélioration", icon: "fa-lightbulb", color: "emerald" }; }
  ...
  else if (totalSuggestions < 5) { nextObjective = { title: "Proposez 5 améliorations", subtitle: "Trophée Esprit Critique", description: "Continuez à perfectionner nos outils ! Proposez 5 améliorations pertinentes pour l'équipe.", current: totalSuggestions, target: 5, unit: "Améliorations", icon: "fa-magnifying-glass-plus", color: "emerald" }; }
  ...
  else if (totalSuggestions < 20) { nextObjective = { title: "Proposez 20 améliorations", subtitle: "Trophée Architecte du Futur", description: "Votre esprit critique est un atout majeur. Atteignez 20 améliorations pour ce grade d'excellence.", current: totalSuggestions, target: 20, unit: "Améliorations", icon: "fa-drafting-compass", color: "emerald" }; }
