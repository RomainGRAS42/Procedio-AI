        ...
        <div
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div
                className={`w-12 h-12 rounded-[1.25rem] bg-slate-50 text-slate-400 flex items-center justify-center text-xl shadow-sm shrink-0`}>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center mt-1">
            <p className={`text-5xl font-black ${stat.color} tracking-tighter leading-none mb-3`}>
              {stat.value}
            </p>
          ...
          {/* Decorative bar - Hidden by default, appears on hover with semantic color */}
          <div
